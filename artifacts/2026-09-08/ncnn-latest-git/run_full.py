"""Serial frozen-binary ncnn upgrade comparison with existing resource bounds."""
import hashlib
import json
import os
...
env = {**os.environ,'OMP_NUM_THREADS':'2','OPENBLAS_NUM_THREADS':'2','HF_HUB_OFFLINE':'1',
       'TRANSFORMERS_OFFLINE':'1','PYTHONDONTWRITEBYTECODE':'1', 'XDG_RUNTIME_DIR':f'/run/user/{os.getuid()}',
...
for version, precision in plan['cases']:
    ...
    binary = base/(version+'-bin')/'ernie-image'
    ...
    unit = 'ernie-latest-ncnn-v1-'+case
