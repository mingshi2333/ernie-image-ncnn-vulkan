...
def oracle(args):
    ...
    fixture = {'scope': 'Teacher-forced real DiT with stage traces; identical official input tensors',
...
def main():
    ...
    report = {'scope': fixture['scope'], 'prediction': result, 'stages': comparisons,
