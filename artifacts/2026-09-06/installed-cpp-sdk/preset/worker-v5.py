...
out=root/'outputs/d1-preset-cpu-v5';out.mkdir(exist_ok=False)
...
commands=[['cmake','--preset','linux-cpu','-DERNIE_NCNN_SOURCE_DIR='+str(ncnn)], ['cmake','--build','--preset','linux-cpu'], ['ctest','--preset','linux-cpu','--no-tests=error']]
