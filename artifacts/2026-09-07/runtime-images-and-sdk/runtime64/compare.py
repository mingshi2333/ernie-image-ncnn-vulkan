...
native=Path(request['native_run'])
...
shared=Path(command[command.index('--model')+1])
...
result={'scope':'Complete saved native text and 8-step runtime64 trajectory versus staged official FP32 modules using identical saved initial latent; CPU2, trace on; not performance or broad perceptual acceptance',
