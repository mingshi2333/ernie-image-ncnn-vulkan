...
wine_env = {**env, 'WINEPREFIX': str(OUT / 'wine-prefix'), 'WINEARCH': 'win64',
...
try:
    run('wine-init', ['/usr/bin/wineboot', '-i'], wine_env, 60)
    run('wine-persistence', ['/usr/bin/wineserver', '-p60'], wine_env, 30)
