...
phase = sys.argv[1]
# A waiting/failed/partial grid cannot authorize a second GPU workload.
...
out.mkdir()
uid = os.getuid()
unit = 'ernie-compact-reader512-v1-' + phase
...
native_binary = (BASE / 'ernie-image.snapshot').resolve()
native_pids = set()
