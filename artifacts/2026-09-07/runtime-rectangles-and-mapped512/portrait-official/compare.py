...
native=Path('/var/tmp/ernie-runtime-rectangles-v1/portrait')
...
result={'scope':'Installed native text and 8-step runtime384x512 trajectory with source hidden/network disabled versus staged official FP32 modules using identical saved initial latent; official CUDA blocks/CPU text-heads-VAE, native Vulkan blocks/CPU text-VAE; CPU2 and trace on; not performance or broad perceptual acceptance',
