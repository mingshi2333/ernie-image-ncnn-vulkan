...
大尺寸批次的首个共享 source32 / 1376×768 已完成：原生和官方均退出 0、无 OOM，全部 25/25 张量通过，PNG 平均差 0.000617291/255、最大差 1/255。根任务已独立重算全部 32,098,304 个有限值；其余三个尺寸仍在继续，见[执行记录](../artifacts/2026-09-07/runtime-large/README.md)和[冻结协议](../artifacts/2026-09-07/runtime-large-protocol/README.md)。这是新输入/配置的结果，下面旧 source64 / 1376×768 的失败继续保留。日常使用返回[项目入口](../README.md)或[运行说明](RUNNING.md)。
