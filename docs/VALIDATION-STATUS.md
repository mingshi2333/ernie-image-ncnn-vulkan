...
正在进行的大尺寸批次见[执行记录](../artifacts/2026-09-07/runtime-large/README.md)和[冻结协议](../artifacts/2026-09-07/runtime-large-protocol/README.md)。其启动快照不代表四个尺寸已完成。日常使用返回[项目入口](../README.md)或[运行说明](RUNNING.md)。
