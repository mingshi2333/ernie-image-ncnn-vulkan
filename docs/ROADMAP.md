...
- [ ] 对完整范围执行计划中的官方/native 出图 canary 和极端长宽比实际推理；共享 source32 已补齐 [768×768、1024×1024 完整执行](../artifacts/2026-09-07/runtime-squares/README.md)，无 OOM，但原数值门槛分别为 18/25、24/25。完整矩阵和 F1 仍未完成。
