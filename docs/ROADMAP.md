...
- [ ] 对完整范围执行计划中的官方/native 出图 canary 和极端长宽比实际推理；共享 source32 已补齐 [768×768、1024×1024 完整执行](../artifacts/2026-09-07/runtime-squares/README.md)，无 OOM，但原数值门槛分别为 18/25、24/25。新 [1376×768 / source32](../artifacts/2026-09-07/runtime-large/README.md) 完整执行且 25/25 张量和 PNG 最大差 1/255 通过、无 OOM，旧 source64 失败保留；其余大尺寸和极端长宽比仍待完成。完整矩阵和 F1 仍未完成。
