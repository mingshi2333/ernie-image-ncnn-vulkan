...
- [ ] 对完整范围执行计划中的官方/native 出图 canary 和极端长宽比实际推理；共享 source32 已补齐 [768×768、1024×1024 完整执行](../artifacts/2026-09-07/runtime-squares/README.md)，无 OOM，但原数值门槛分别为 18/25、24/25。新 [四种 source32 大尺寸](../artifacts/2026-09-07/runtime-large/README.md)（1376×768、768×1376、2048×1024、1024×2048）全部完整执行，每例 25/25 张量通过、PNG 最大差 1/255，无 OOM；2048×1024 官方阶段有 cgroup 上限事件。旧 source64 失败保留；极端长宽比实际执行仍待完成。完整矩阵和 F1 仍未完成。
