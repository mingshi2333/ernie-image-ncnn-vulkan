...
def reference(package,prompt,output,steps):
    ...
    for i,t in enumerate(scheduler.timesteps):
        ...
        x=captured['x'];temb=[v.view(1,1,4096) for v in captured['ada'].chunk(6,dim=-1)]
        for index in range(36):
            ...
            x=block(x,freqs,temb,attention_mask=synth[-1][None,None]);del block
...
def main():
    ...
    if args.reference:
        ...
        fixture=reference(args.model,args.prompt,ref,args.steps)
