...
- Fixed 1024x1024 encoder and production strength-zero reconstruction have independent actual evidence: three encoder and six reconstruction boundaries pass, PNG max1. See `.superpowers/sdd/2026-09-06-surpass-reference/task-F2-strength0-1024-review.md`; positive strength and formal15 remain separate. Linux CPU/Vulkan installed C++ consumption is recorded in `artifacts/2026-09-06/installed-cpp-sdk/README.md`; this is API/installation evidence, not full-model or Windows/macOS acceptance.
